            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid sm:grid-cols-2 gap-4">
                <input
                  ...
                  required
                  className="w-full bg-white text-heading placeholder-gray-400 border border-gray-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-primary-light transition-colors"
                  style={{ fontFamily: "var(--font-dm)" }}
                />
                <input
                  type="tel"
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={5}
                className="w-full bg-white text-heading placeholder-gray-400 border border-gray-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-primary-light transition-colors resize-none"
                style={{ fontFamily: "var(--font-dm)" }}
              />
              <button
                type="submit"
